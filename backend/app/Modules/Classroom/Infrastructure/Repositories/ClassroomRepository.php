...
class ClassroomRepository implements ClassroomRepositoryInterface
{
    public function findById(int $id) {
        ...
        return new ClassroomEntity( $model->id, new ClassroomName($model->name), $model->formateur_id ); 
    }
    ...
    public function findAll() {
        ...
        foreach ($model as $item) {
            $entities[] = new ClassroomEntity( $item->id, new ClassroomName($item->name), $item->formateur_id );
        }
        return $entities;
    }
    ...
    public function assignFormateur(int $classroomId, int $formateurId) {
        $model = ClassroomModel::find($classroomId);
        if ($model) {
